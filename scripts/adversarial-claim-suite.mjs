...
BEGIN
  ...
  INSERT INTO results VALUES ('T3 second call is a no-op',
    res::text, '{"blocked": 0, "claimed": 0, "stamped": 0, "eligible": true}');
  ...
  INSERT INTO results VALUES ('T5 unconfirmed phone claims nothing',
    res::text, '{"blocked": 0, "claimed": 0, "stamped": 0, "eligible": false}');
  ...
  INSERT INTO results VALUES ('T7 unmapped purchase left claimable',
    res::text || ' unclaimed=' || n::text, '{"blocked": 0, "claimed": 0, "stamped": 0, "eligible": true} unclaimed=1');
  ...
  INSERT INTO results VALUES ('T8 revoked student stays revoked, row stays claimable',
    ...
    '{"blocked": 1, "claimed": 0, "stamped": 0, "eligible": true} active=0 claimable=1');
  ...
  INSERT INTO results VALUES ('T8c already entitled is reconciled, not re-granted',
    res::text || ' enrolments=' || n::text, '{"blocked": 0, "claimed": 0, "stamped": 1, "eligible": true} enrolments=1');
  ...
  BEGIN
    ...
    INSERT INTO results VALUES ('T9 duplicate purchases collapse',
      res::text || ' enrolments=' || n::text, '{"blocked": 0, "claimed": 2, "stamped": 3, "eligible": true} enrolments=2');
  EXCEPTION WHEN OTHERS THEN
    INSERT INTO results VALUES ('T9 duplicate purchases collapse',
  ...
  EXCEPTION WHEN OTHERS THEN
    INSERT INTO results VALUES ('T10 anon claims nothing, no raise',
      'RAISED ' || SQLSTATE, '{"blocked": 0, "claimed": 0, "stamped": 0, "eligible": false}');
  END;
  ...
  BEGIN
    ...
    INSERT INTO results VALUES ('T11 malformed sub degrades', res::text,
      '{"blocked": 0, "claimed": 0, "stamped": 0, "eligible": false}');
  EXCEPTION WHEN OTHERS THEN
  ...
  -- eligible=true is CORRECT here: this caller is identifiable, live and
  -- phone-confirmed, so the claim genuinely RAN — it just matched nothing of
  -- theirs. eligible means "we could act on you", not "we found something",
  -- which is exactly why it is safe for the client to burn its watermark on it.
