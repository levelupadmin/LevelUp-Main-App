...
**The measured end state for the nine R0 tables.** Recorded verbatim in the backbone's A6 item (9) (`20260729100000_cohort_rooms_backbone.sql:2536-2566`): the bootstrap armed first, the nine tables created, then all 38 `GRANT`/`REVOKE … ON public.<one of the nine>` statements in `20260729100000` + `20260729100100` replayed in file order (`20260729100200` issues none, so the set is complete). For `authenticated` — **`anon` holds ZERO rows**:
