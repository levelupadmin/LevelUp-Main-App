    ...
    <div className="min-h-screen bg-background">
      ...
      <aside className="fixed left-0 top-0 z-40 hidden h-screen w-60 flex-col border-r border-border bg-card lg:flex">
        ...
        <div className="flex h-14 items-center gap-2.5 border-b border-border px-5">
          ...
          <span className="text-base font-bold text-gradient">Level Up</span>
        </div>
      ...
      {/* Top Bar */}
      <header className="fixed left-0 right-0 top-0 z-50 border-b border-border bg-background/80 backdrop-blur-xl lg:left-60">
        <div className="flex h-14 items-center justify-between px-4 lg:px-6">
          ...
          <div className="flex items-center gap-2 lg:hidden">
            ...
            <span className="text-sm font-bold text-gradient">Level Up</span>
          </div>

          {/* Desktop: page context or search */}
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-40 lg:hidden">
          ...
          <aside className="absolute left-0 top-0 h-full w-64 border-r border-border bg-card shadow-elevated">
            <div className="flex h-14 items-center gap-2.5 border-b border-border px-5">
              <img src={logo} alt="Level Up" className="h-7 w-7" />
              <span className="text-base font-bold text-gradient">Level Up</span>
            </div>
      ...
      {/* Mobile bottom tabs */}
      <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-border bg-card/95 backdrop-blur-xl safe-bottom lg:hidden">
