...
const forgePrograms = [
  {
    ...
    subtitle: "A 6-day fully offline residency for aspiring writers",
    location: "Dehradun",
    image: forgeWriting,
  ...
  },
  {
    ...
    subtitle: "Intensive online + offline bootcamp for filmmakers",
    location: "Goa",
  ...
  },
  {
    ...
    subtitle: "Bootcamp for content creators — build, shoot, launch",
    location: "Goa / Bali",
    image: forgeCreators,
